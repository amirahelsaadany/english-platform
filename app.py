...
CURRENCY_MAP = {
    'مصر': ('الجنيه المصري', 'EGP', 'ج.م'),
    'Egypt': ('Egyptian Pound', 'EGP', 'ج.م'),
    'السعودية': ('الريال السعودي', 'SAR', 'ر.س'),
    'Saudi Arabia': ('Saudi Riyal', 'SAR', 'ر.س'),
    'الإمارات': ('الدرهم الإماراتي', 'AED', 'د.إ'),
    'UAE': ('Dirham', 'AED', 'د.إ'),
    'الكويت': ('الدينار الكويتي', 'KWD', 'د.ك'),
    'Kuwait': ('Kuwaiti Dinar', 'KWD', 'د.ك'),
    'البحرين': ('الدينار البحريني', 'BHD', 'د.ب'),
    'Bahrain': ('Bahraini Dinar', 'BHD', 'د.ب'),
    'قطر': ('الريال القطري', 'QAR', 'ر.ق'),
    'Qatar': ('Qatari Riyal', 'QAR', 'ر.ق'),
    'عمان': ('الريال العماني', 'OMR', 'ر.ع'),
    'Oman': ('Omani Riyal', 'OMR', 'ر.ع'),
    'الأردن': ('الدينار الأردني', 'JOD', 'د.أ'),
    'Jordan': ('Jordanian Dinar', 'JOD', 'د.أ'),
    'العراق': ('الدينار العراقي', 'IQD', 'د.ع'),
    'Iraq': ('Iraqi Dinar', 'IQD', 'د.ع'),
    'سوريا': ('الليرة السورية', 'SYP', 'ل.س'),
    'Syria': ('Syrian Pound', 'SYP', 'ل.س'),
    'لبنان': ('الليرة اللبنانية', 'LBP', 'ل.ل'),
    'Lebanon': ('Lebanese Pound', 'LBP', 'ل.ل'),
    'ليبيا': ('الدينار الليبي', 'LYD', 'د.ل'),
    'Libya': ('Libyan Dinar', 'LYD', 'د.ل'),
    'تونس': ('الدينار التونسي', 'TND', 'د.ت'),
    'Tunisia': ('Tunisian Dinar', 'TND', 'د.ت'),
    'الجزائر': ('الدينار الجزائري', 'DZD', 'د.ج'),
    'Algeria': ('Algerian Dinar', 'DZD', 'د.ج'),
    'المغرب': ('الدرهم المغربي', 'MAD', 'د.م'),
    'Morocco': ('Moroccan Dirham', 'MAD', 'د.م'),
    'السودان': ('الجنيه السوداني', 'SDG', 'ج.س'),
    'Sudan': ('Sudanese Pound', 'SDG', 'ج.س'),
    'اليمن': ('الريال اليمني', 'YER', 'ر.ي'),
    'Yemen': ('Yemeni Riyal', 'YER', 'ر.ي'),
    'فلسطين': ('الشيكل', 'ILS', '₪'),
    'Palestine': ('Shekel', 'ILS', '₪'),
    'موريتانيا': ('الأوقية', 'MRU', 'أ.م'),
    'Mauritania': ('Ouguiya', 'MRU', 'أ.م'),
    'الصومال': ('الشلن الصومالي', 'SOS', 'ش.ص'),
    'Somalia': ('Somali Shilling', 'SOS', 'ش.ص'),
    'جيبوتي': ('الفرنك الجيبوتي', 'DJF', 'ف.ج'),
    'Djibouti': ('Djibouti Franc', 'DJF', 'ف.ج'),
    'تركيا': ('الليرة التركية', 'TRY', '₺'),
    'Turkey': ('Turkish Lira', 'TRY', '₺'),
    'باكستان': ('الروبية الباكستانية', 'PKR', 'ر.ب'),
    'Pakistan': ('Pakistani Rupee', 'PKR', 'ر.ب'),
    'ماليزيا': ('الرينغيت', 'MYR', 'RM'),
    'Malaysia': ('Ringgit', 'MYR', 'RM'),
    'إندونيسيا': ('الروبية الإندونيسية', 'IDR', 'Rp'),
    'Indonesia': ('Rupiah', 'IDR', 'Rp'),
    'نيجيريا': ('النيرة', 'NGN', '₦'),
    'Nigeria': ('Naira', 'NGN', '₦'),
    'الولايات المتحدة': ('الدولار الأمريكي', 'USD', '$'),
    'United States': ('US Dollar', 'USD', '$'),
    'المملكة المتحدة': ('الجنيه الإسترليني', 'GBP', '£'),
    'United Kingdom': ('British Pound', 'GBP', '£'),
    'كندا': ('الدولار الكندي', 'CAD', 'C$'),
    'Canada': ('Canadian Dollar', 'CAD', 'C$'),
    'أستراليا': ('الدولار الأسترالي', 'AUD', 'A$'),
